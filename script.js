document.addEventListener('DOMContentLoaded', function() {
    ...
    const skillsData = {
        'Cloud Architecture': 'System Design & Architecture Diagrams, Resource Provisioning & Management, Governance & Policy Compliance',
        'Data Engineering': 'ETL Pipeline Design, Data Processing & Transformation (Databricks), Data Analytics (Pandas, Streamlit), Data Warehousing (Azure SQL)',
        'Cloud Computing': 'Azure App Service, Azure SQL Database, App Service Plans, Deployment Slots',
        'CI/CD & IaC': 'GitHub Actions, Docker, ARM Templates, Bicep',
        'Development': 'Python, Java, JavaScript, Node.js, Git, JEST, ESLint',
    };
    ...
    const skillCategoryDetail = document.getElementById('skill-category-detail');
    ...
    const skillsChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [5, 5, 4, 4, 5], // Arbitrary values for visualization balance
                backgroundColor: [
                    'rgba(79, 70, 229, 0.7)',
                    'rgba(99, 102, 241, 0.7)',
    ...
    Object.keys(skillsData).forEach((skill, index) => {
        ...
        button.className = 'skill-button px-4 py-2 rounded-lg text-sm font-semibold bg-slate-200 text-slate-700 hover:bg-indigo-500 hover:text-white transition-colors';
        ...
        button.addEventListener('click', () => {
            ...
            skillCategoryTitle.textContent = skill;
            skillCategoryDetail.textContent = skillsData[skill];
        });
